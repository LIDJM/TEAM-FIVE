							...
							<div class='row'>
								<div class='col-md-4'>
									<select class='form-control' name='' id=''>
										<option value='Codigo_Cliente_1'>
											Codigo_Cliente_1
										</option>
										<option value='Codigo_Cliente_2'>
											Codigo_Cliente_2
										</option>
										<option value='Codigo_Cliente_3'>
											Codigo_Cliente_3
										</option>
									</select>
								</div>
								<div class='col-md-4'>
									<select class='form-control' name='' id=''>
										...
										<option value='898.741.454-1'>
											898.741.454-1
										</option>
										<option value='921.451.985-9'>
											921.451.985-9
										</option>
									</select>
								</div>
